...
void blacklistMan::loadblacklist() {
    ...
    blacklist = Mod::get()->getSavedValue<std::unordered_set<int>>("blacklist@" + songListMan::getDomain(),{});
}

void blacklistMan::saveBlacklist() {
    log::info("{}",blacklistMan::blacklist);
    Mod::get()->setSavedValue("blacklist@" + songListMan::getDomain(),blacklistMan::blacklist);
}
